...
**Data Structures** — singly and doubly linked lists: traverse, search, insert, delete.
...
Click **Enter**, then go through **Algorithms** or **Data Structures**. Pick something from a wall or the chooser, then use Play / Next / Previous / Reset like a normal playback. Graphs ask for a start node (and a target for pathfinding).
